                                ...
                                <div class="row">
                                            ...
                                            <div class="controls">
                                                <select class="form-control select2" name="tag_id" style="width: 100%;">
                                                    ...
                                                    @foreach ($all_tag as $tag)
                                                        <option value="{{ $tag->id }}" {{ ($tag->id == $data->tag_id)? 'selected' : '' }}>{{ $tag->name_en }} | {{ $tag->name_ar }}</option>
                                                    @endforeach
                                                </select>
                                                @error('tag_id')
                                                    <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ URL::to($data->image) }}" class="post_image_preview" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row"> <!-- start 8th row -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="details_en" id="editor11" class="form-control">{{ $data->details_en }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="details_ar" id="editor12" class="form-control">{{ $data->details_ar }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end 8th row -->
