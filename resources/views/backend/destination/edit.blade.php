            ...
            <div class="col-12">
                ...
                <div class="box">
                   <div class="box-header with-border">
                     <h3 class="box-title">Edit Top Destination</h3>
                   </div>
                   <!-- /.box-header -->
                   <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="number_of_place" class="form-control" value="{{ $data->number_of_place }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="number_of_hotal" class="form-control" value="{{ $data->number_of_hotal }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ URL::to($data->image) }}" class="destination_image_preview" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="departure_en" class="form-control" value="{{ $data->departure_en }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="departure_ar" class="form-control" value="{{ $data->departure_ar }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row"> <!-- start 8th row -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="detials_en" id="editor9" class="form-control">{{ $data->detials_en }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="detials_ar" id="editor10" class="form-control">{{ $data->detials_ar }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end 8th row -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="destination_map_link" class="form-control" value="{{ $data->destination_map_link }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
