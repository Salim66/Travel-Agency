            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        ...
                        <h3 class="box-title">Completed Booking Package List</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action_class">
                                            ...
                                            <a title="Package Pending" href="{{ route('booking.package.pending', $data->id) }}" class="btn btn-danger"><i class="fa fa-arrow-down"></i></a>
