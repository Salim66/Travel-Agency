        ...
        <div class="breadcrumb breadcrumb-style-one">
            <div class="container">
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="breadcrumb-title">{{ $tag->name_ar }}</h2>
                    <ul class="d-flex justify-content-center breadcrumb-items">
                        <li class="breadcrumb-item"><a href="index.html">العلامات</a></li>
                        <li class="breadcrumb-item active">{{ $tag->name_ar }}</li>
                    </ul>
                </div>
                @else
                <div class="col-lg-12 text-center">
                    <h2 class="breadcrumb-title">{{ $tag->name_en }}</h2>
                    <ul class="d-flex justify-content-center breadcrumb-items">
                        <li class="breadcrumb-item"><a href="index.html">Tags</a></li>
                        <li class="breadcrumb-item active">{{ $tag->name_en }}</li>
                    </ul>
                </div>
                @endif
            </div>
